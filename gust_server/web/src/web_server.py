...
from gust_server.src import Gust_Sources, File_Download, Server_Global
from gust_server.web.src.web_helpers import Web_Helpers
...
def Trigger_Source_Update():
    ...
    Web_Helpers.New_Or_Update(source_name,source_url,hash_url,hash_type)
